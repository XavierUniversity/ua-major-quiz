<template>
    <div>
        ...
        <p v-if="mode === 'explore'">
            ...
            <span v-if="loaderCount > 2"> We also think these would be great majors for you to explore as you continue
                your college
                search.
